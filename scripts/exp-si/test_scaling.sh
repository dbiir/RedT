...
# # RedT
# cd ../../RedTR/scripts 
# python run_experiments.py -e -c vcloud ycsb_scaling_no_ro -l 20 0
# sleep 10
# python run_experiments.py -e -c vcloud tpcc_scaling_n_no_ro -l 20 0
# sleep 10
# python run_experiments.py -e -c vcloud tpcc_scaling_p_no_ro -l 20 0
# sleep 10
# python run_experiments.py -e -c vcloud tpcc_scaling_no_ro -l 20 0
# sleep 10
