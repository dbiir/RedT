...
void BaseQuery::init() { 
  ...
  DEBUG_M("BaseQuery::init array centers\n");
  centers.init(g_center_cnt);
  DEBUG_M("BaseQuery::init array centers_touched\n");
  centers_touched.init(g_center_cnt);
