...
double g_similar_group_perc = SIMILAR_GROUP_PERC;
...
uint64_t in_latency_[5] = {999, 999, 999, 999, 999};
uint64_t latency_[5] = {999, 999, 999, 999, 999};
uint64_t access_count_[PART_CNT] = {0};
bool is_count_[PART_CNT] = {false};
