...
(* --algorithm RedT 
  variables
    ...
    \* The count for recover failed replica node
  ...
  \* Check if the read/write lock is available.
  define 
    IsReadLockAvailable(item, replica) == ReadLocks[item][replica] = 0
  ...
  begin
    ...
    if TransactionStatus[id][t].status = "NotStarted" /\ IsWriteLockAvailable(i, j) then
      ...
      ReadLocks[i][j] := ReadLocks[i][j] + 1;
      TransactionStatus[id][t].status := "ReadSuccess";
      res_msg := [item |-> i, replica |-> j, transaction |-> t, type |-> "Process-ack", status |-> "ReadSuccess", value |-> Replicas[i][j], wts |-> Timestamps[i][j], sendTime |-> CurrentTime, coordinator_id |-> msg.coordinator_id];
  ...
  begin
    ...
    j := msg.replica;
    t := msg.transaction;
    if TransactionStatus[id][t].status = "NotStarted" /\
      IsReadLockAvailable(i, j) /\ IsWriteLockAvailable(i, j) then
  ...
  begin
    ...
    if TransactionStatus[id][t].status = "ReadSuccess" then
      readValue := Replicas[i][j];
      readWTS := Timestamps[i][j];
    else
      readValue := 0;
      readWTS := 0;
    end if;
...
\* BEGIN TRANSLATION (chksum(pcal) = "bced2f40" /\ chksum(tla) = "b20acf11")
\* Label ProcHandleWriteB of procedure HandleWrite at line 337 col 5 changed to ProcHandleWriteB_
\* Process variable id of process Coordinator at line 572 col 12 changed to id_
\* Process variable id of process Replica at line 596 col 12 changed to id_R
\* Procedure variable t of procedure SendTransactions at line 85 col 13 changed to t_
\* Procedure variable targetReplica of procedure SendTransactions at line 85 col 47 changed to targetReplica_
\* Procedure variable s_msg of procedure SendTransactions at line 85 col 66 changed to s_msg_
...
\* Procedure variable res_msg of procedure HandleRead at line 291 col 34 changed to res_msg_
\* Procedure variable i of procedure HandleWrite at line 316 col 13 changed to i_H
\* Procedure variable j of procedure HandleWrite at line 316 col 20 changed to j_H
\* Procedure variable t of procedure HandleWrite at line 316 col 27 changed to t_Ha
\* Procedure variable res_msg of procedure HandleWrite at line 316 col 34 changed to res_msg_H
\* Procedure variable i of procedure HandleInquire at line 342 col 13 changed to i_Ha
\* Procedure variable j of procedure HandleInquire at line 342 col 20 changed to j_Ha
\* Procedure variable t of procedure HandleInquire at line 342 col 27 changed to t_Han
\* Procedure variable res_msg of procedure HandleInquire at line 342 col 34 changed to res_msg_Ha
\* Procedure variable i of procedure HandleCommit at line 363 col 13 changed to i_Han
\* Procedure variable j of procedure HandleCommit at line 363 col 20 changed to j_Han
\* Procedure variable t of procedure HandleCommit at line 363 col 27 changed to t_Hand
\* Procedure variable res_msg of procedure HandleCommit at line 363 col 43 changed to res_msg_Han
\* Procedure variable i of procedure HandleAbort at line 390 col 13 changed to i_Hand
\* Procedure variable j of procedure HandleAbort at line 390 col 20 changed to j_Hand
\* Procedure variable t of procedure HandleAbort at line 390 col 27 changed to t_Handl
\* Procedure variable msg of procedure HandleSyncAck at line 432 col 13 changed to msg_H
\* Procedure variable msg of procedure ReplicaReceiveRequest at line 457 col 13 changed to msg_R
\* Procedure variable type of procedure ReplicaReceiveRequest at line 457 col 23 changed to type_R
\* Procedure variable msg of procedure NodeFail at line 484 col 13 changed to msg_N
\* Procedure variable s_msg of procedure CoordinatorRecover at line 523 col 13 changed to s_msg_Co
\* Parameter cid of procedure SendTransactions at line 84 col 30 changed to cid_
...
\* Parameter msg of procedure HandleWrite at line 315 col 25 changed to msg_Han
\* Parameter id of procedure HandleWrite at line 315 col 30 changed to id_Ha
\* Parameter msg of procedure HandleInquire at line 341 col 27 changed to msg_Hand
\* Parameter id of procedure HandleInquire at line 341 col 32 changed to id_Han
\* Parameter msg of procedure HandleCommit at line 362 col 26 changed to msg_Handl
\* Parameter id of procedure HandleCommit at line 362 col 31 changed to id_Hand
\* Parameter msg of procedure HandleAbort at line 389 col 25 changed to msg_Handle
\* Parameter id of procedure HandleAbort at line 389 col 30 changed to id_Handl
\* Parameter id of procedure HandleSync at line 410 col 29 changed to id_Handle
\* Parameter id of procedure HandleSyncAck at line 431 col 27 changed to id_HandleS
\* Parameter id of procedure ReplicaReceiveRequest at line 456 col 35 changed to id_Re
\* Parameter id of procedure NodeFail at line 483 col 22 changed to id_N
\* Parameter id of procedure CoordinatorRecover at line 522 col 32 changed to id_C
CONSTANT defaultInitValue
VARIABLES DataItems, Replicas, Transactions, Messages, CoordinatorMessages, 
          ReadLocks, WriteLocks, Logs, Timestamps, TransactionStatusCoor, 
          TransactionStatus, CurrentTransaction, SuccessCounts, FailureCounts, 
          ReadResults, ReadConsistency, DoneCounts, NodeStatus, FailedCounts, 
          CommitCounts, CommitTS, AbortCounts, SyncCounts, CurrentTime, 
          SystemTerminated, RecieveACKCount, pc, stack
...
VARIABLES cid_, t_, i1, j1, Test, targetReplica_, s_msg_, t, msg_Ca, cid_C, 
          ...
          msg_C, type_C, recoveryTid, msg_Ha, id_H, i_, j_, t_H, res_msg_, 
          msg_Han, id_Ha, i_H, j_H, t_Ha, res_msg_H, msg_Hand, id_Han, i_Ha, 
          j_Ha, t_Han, res_msg_Ha, readValue, readWTS, msg_Handl, id_Hand, 
          i_Han, j_Han, t_Hand, idx, res_msg_Han, msg_Handle, id_Handl, 
          i_Hand, j_Hand, t_Handl, res_msg, msg, id_Handle, i, j, id_HandleS, 
          msg_H, i13, j13, id_Re, msg_R, type_R, id_N, msg_N, type, id_C, 
          s_msg_Co, i8, j8, id, s_msg, dataItemId, id_, id_R

vars == << DataItems, Replicas, Transactions, Messages, CoordinatorMessages, 
           ReadLocks, WriteLocks, Logs, Timestamps, TransactionStatusCoor, 
           TransactionStatus, CurrentTransaction, SuccessCounts, 
           FailureCounts, ReadResults, ReadConsistency, DoneCounts, 
           NodeStatus, FailedCounts, CommitCounts, CommitTS, AbortCounts, 
           SyncCounts, CurrentTime, SystemTerminated, RecieveACKCount, pc, 
           stack, cid_, t_, i1, j1, Test, targetReplica_, s_msg_, t, msg_Ca, 
           cid_C, cid_Co, quorom_, minority, t_C, i7, j7, commitTimestamp, 
           targetReplica_C, decision, allSuccessful, s_msg_C, cid_Coo, quorom, 
           t_Co, targetReplica, cid_Coor, msg_, type_, recoveryTid_, cid, 
           msg_C, type_C, recoveryTid, msg_Ha, id_H, i_, j_, t_H, res_msg_, 
           msg_Han, id_Ha, i_H, j_H, t_Ha, res_msg_H, msg_Hand, id_Han, i_Ha, 
...
ProcSendTransaction(self) == /\ pc[self] = "ProcSendTransaction"
                             ...
                             /\ UNCHANGED << DataItems, Replicas, Transactions, 
                                             Messages, CoordinatorMessages, 
                                             ReadLocks, WriteLocks, Logs, 
                                             Timestamps, TransactionStatus, 
...
ProcSendTransactionB(self) == /\ pc[self] = "ProcSendTransactionB"
                              ...
                              /\ UNCHANGED << DataItems, Replicas, 
                                              Transactions, Messages, 
                                              CoordinatorMessages, ReadLocks, 
                                              WriteLocks, Logs, Timestamps, 
                                              TransactionStatusCoor, 
                                              TransactionStatus, 
                                              CurrentTransaction, 
                                              SuccessCounts, FailureCounts, 
                                              ...
                                              i, j, id_HandleS, msg_H, i13, 
                                              j13, id_Re, msg_R, type_R, id_N, 
                                              msg_N, type, id_C, s_msg_Co, i8, 
                                              j8, id, s_msg, dataItemId, id_, 
                                              id_R >>
...
ProcCalculateCounts(self) == /\ pc[self] = "ProcCalculateCounts"
                             ...
                             /\ UNCHANGED << DataItems, Replicas, Transactions, 
                                             Messages, CoordinatorMessages, 
                                             ReadLocks, WriteLocks, Logs, 
                                             Timestamps, TransactionStatusCoor, 
                                             TransactionStatus, 
...
ProcCoorDec(self) == /\ pc[self] = "ProcCoorDec"
                     ...
                     /\ UNCHANGED << DataItems, Replicas, Transactions, 
                                     Messages, CoordinatorMessages, ReadLocks, 
                                     WriteLocks, Logs, Timestamps, 
...
ProcCoorDecA(self) == /\ pc[self] = "ProcCoorDecA"
                      ...
                      /\ UNCHANGED << DataItems, Replicas, Transactions, 
                                      ...
                                      i_, j_, t_H, res_msg_, msg_Han, id_Ha, 
...
IfSuccess(self) == /\ pc[self] = "IfSuccess"
                   ...
                   /\ minority' = [minority EXCEPT ![self] = Head(stack[self]).minority]
                   /\ stack' = [stack EXCEPT ![self] = Tail(stack[self])]
                   /\ UNCHANGED << DataItems, Replicas, Transactions, Messages, 
                                   CoordinatorMessages, ReadLocks, WriteLocks, 
                                   Logs, Timestamps, TransactionStatusCoor, 
                                   TransactionStatus, CurrentTransaction, 
                                   SuccessCounts, FailureCounts, ReadResults, 
                                   ReadConsistency, DoneCounts, NodeStatus, 
                                   FailedCounts, CommitCounts, CommitTS, 
                                   AbortCounts, SyncCounts, CurrentTime, 
                                   SystemTerminated, RecieveACKCount, cid_, t_, 
                                   i1, j1, Test, targetReplica_, s_msg_, t, 
                                   msg_Ca, cid_C, cid_Coo, quorom, t_Co, 
                                   targetReplica, cid_Coor, msg_, type_, 
                                   recoveryTid_, cid, msg_C, type_C, 
                                   recoveryTid, msg_Ha, id_H, i_, j_, t_H, 
                                   res_msg_, msg_Han, id_Ha, i_H, j_H, t_Ha, 
...
ProcCoorFinDecideC(self) == /\ pc[self] = "ProcCoorFinDecideC"
                            ...
                            /\ UNCHANGED << DataItems, Replicas, Transactions, 
                                            ...
                                            recoveryTid_, cid, msg_C, type_C, 
                                            recoveryTid, msg_Ha, id_H, i_, j_, 
                                            t_H, res_msg_, msg_Han, id_Ha, i_H, 
...
ProcHandleRead(self) == /\ pc[self] = "ProcHandleRead"
                        ...
                        /\ IF TransactionStatus[id_H[self]][t_H'[self]].status = "NotStarted" /\ IsWriteLockAvailable(i_'[self], j_'[self])
                              THEN /\ ReadLocks' = [ReadLocks EXCEPT ![i_'[self]][j_'[self]] = ReadLocks[i_'[self]][j_'[self]] + 1]
                                   /\ TransactionStatus' = [TransactionStatus EXCEPT ![id_H[self]][t_H'[self]].status = "ReadSuccess"]
                                   /\ res_msg_' = [res_msg_ EXCEPT ![self] = [item |-> i_'[self], replica |-> j_'[self], transaction |-> t_H'[self], type |-> "Process-ack", status |-> "ReadSuccess", value |-> Replicas[i_'[self]][j_'[self]], wts |-> Timestamps[i_'[self]][j_'[self]], sendTime |-> CurrentTime, coordinator_id |-> msg_Ha[self].coordinator_id]]
                        ...
                        /\ UNCHANGED << DataItems, Replicas, Transactions, 
                                        Messages, WriteLocks, Logs, Timestamps, 
                                        TransactionStatusCoor, 
                                        CurrentTransaction, SuccessCounts, 
                                        FailureCounts, ReadResults, 
                                        ReadConsistency, DoneCounts, 
...
ProcHandleWrite(self) == /\ pc[self] = "ProcHandleWrite"
                         ...
                         /\ IF  TransactionStatus[id_Ha[self]][t_Ha'[self]].status = "NotStarted" /\
                               IsReadLockAvailable(i_H'[self], j_H'[self]) /\ IsWriteLockAvailable(i_H'[self], j_H'[self])
...
ProcHandleInquire(self) == /\ pc[self] = "ProcHandleInquire"
                           ...
                           /\ IF TransactionStatus[id_Han[self]][t_Han'[self]].status = "ReadSuccess"
                                 THEN /\ readValue' = [readValue EXCEPT ![self] = Replicas[i_Ha'[self]][j_Ha'[self]]]
                                      /\ readWTS' = [readWTS EXCEPT ![self] = Timestamps[i_Ha'[self]][j_Ha'[self]]]
...
ProcHandleCommit(self) == /\ pc[self] = "ProcHandleCommit"
                          ...
                          /\ Timestamps' = [Timestamps EXCEPT ![i_Han'[self]][j_Han'[self]] = msg_Handl[self].timestamp]
                          ...
                          /\ IF WriteLocks[i_Han'[self]][j_Han'[self]]
                                THEN /\ WriteLocks' = [WriteLocks EXCEPT ![i_Han'[self]][j_Han'[self]] = FALSE]
                                     /\ UNCHANGED ReadLocks
                                ELSE /\ ReadLocks' = [ReadLocks EXCEPT ![i_Han'[self]][j_Han'[self]] = ReadLocks[i_Han'[self]][j_Han'[self]] - 1]
                          ...
                          /\ UNCHANGED << DataItems, Replicas, Transactions, 
                                          Messages, TransactionStatusCoor, 
                                          CurrentTransaction, SuccessCounts, 
                                          FailureCounts, ReadResults, 
                                          ReadConsistency, DoneCounts, 
                                          NodeStatus, FailedCounts, 
...
ProcHandleAbort(self) == /\ pc[self] = "ProcHandleAbort"
                         ...
                         /\ IF WriteLocks[i_Hand'[self]][j_Hand'[self]]
                               THEN /\ WriteLocks' = [WriteLocks EXCEPT ![i_Hand'[self]][j_Hand'[self]] = FALSE]
                                    /\ UNCHANGED ReadLocks
                               ELSE /\ ReadLocks' = [ReadLocks EXCEPT ![i_Hand'[self]][j_Hand'[self]] = ReadLocks[i_Hand'[self]][j_Hand'[self]] - 1]
                                    /\ UNCHANGED WriteLocks
...
ProcHandleSync(self) == /\ pc[self] = "ProcHandleSync"
                        ...
                        /\ UNCHANGED << DataItems, Replicas, Transactions, 
                                        ...
                                        msg_, type_, recoveryTid_, cid, msg_C, 
                                        type_C, recoveryTid, msg_Ha, id_H, i_, 
                                        j_, t_H, res_msg_, msg_Han, id_Ha, i_H, 
                                        j_H, t_Ha, res_msg_H, msg_Hand, id_Han, 
                                        i_Ha, j_Ha, t_Han, res_msg_Ha, 
                                        readValue, readWTS, msg_Handl, id_Hand, 
                                        i_Han, j_Han, t_Hand, idx, res_msg_Han, 
                                        msg_Handle, id_Handl, i_Hand, j_Hand, 
...
ProcHandleSyncAck(self) == /\ pc[self] = "ProcHandleSyncAck"
                           /\ IF \E m \in Messages : m.targetReplica = id_HandleS[self] /\ m.type = "SyncAck"
                                 THEN /\ msg_H' = [msg_H EXCEPT ![self] = CHOOSE m \in Messages : m.targetReplica = id_HandleS[self] /\ m.type = "SyncAck"]
                                      ...
                                      /\ IF Timestamps[i13'[self]][j13'[self]] < msg_H'[self].wts
                                            THEN /\ Timestamps' = [Timestamps EXCEPT ![i13'[self]][j13'[self]] = msg_H'[self].wts]
                                                 /\ Replicas' = [Replicas EXCEPT ![i13'[self]][j13'[self]] = msg_H'[self].value]
                                            ELSE /\ TRUE
                                                 /\ UNCHANGED << Replicas, 
                                                                 Timestamps >>
                                 ...
                                 ELSE /\ TRUE
                                      /\ UNCHANGED << Replicas, Messages, Logs, 
                                                      Timestamps, NodeStatus, 
                                                      SyncCounts, msg_H, i13, 
                                                      j13 >>
                           /\ pc' = [pc EXCEPT ![self] = "ProcHandleSyncAckB"]
                           /\ UNCHANGED << DataItems, Transactions, 
                                           CoordinatorMessages, ReadLocks, 
...
ProcRepRecReq(self) == /\ pc[self] = "ProcRepRecReq"
                       ...
                       /\ UNCHANGED << DataItems, Replicas, Transactions, 
                                       ...
                                       t_Ha, res_msg_H, msg_Hand, id_Han, i_Ha, 
                                       j_Ha, t_Han, res_msg_Ha, readValue, 
                                       readWTS, msg_Handl, id_Hand, i_Han, 
                                       j_Han, t_Hand, idx, res_msg_Han, 
                                       msg_Handle, id_Handl, i_Hand, j_Hand, 
...
ProcSetNodeFail(self) == /\ pc[self] = "ProcSetNodeFail"
                         /\ IF FailedN /= 0 /\ id_N[self] = FailedN /\ FailedCounts[id_N[self]] < FCount
                               THEN /\ NodeStatus' = [NodeStatus EXCEPT ![id_N[self]] = "Failed"]
                                    ...
                                    /\ \E i12 \in 1..N:
                                         /\ ReadLocks' = [ReadLocks EXCEPT ![i12][id_N[self]] = 0]
                               ...
                               ELSE /\ IF FailedC /= 0 /\ id_N[self] = FailedC + (N * M) /\ FailedCounts[id_N[self]] < FCount
                                          ...
                                          ELSE /\ TRUE
                                               /\ UNCHANGED << TransactionStatusCoor, 
                                                               ...
                                                               CommitTS, 
                                                               AbortCounts >>
                                    /\ UNCHANGED << ReadLocks, WriteLocks, 
                                                    Logs, TransactionStatus >>
                         /\ pc' = [pc EXCEPT ![self] = "ProcSetNodeFailB"]
                         /\ UNCHANGED << DataItems, Replicas, Transactions, 
                                         Messages, CoordinatorMessages, 
                                         Timestamps, SyncCounts, CurrentTime, 
                                         SystemTerminated, RecieveACKCount, 
                                         stack, cid_, t_, i1, j1, Test, 
                                         targetReplica_, s_msg_, t, msg_Ca, 
                                         cid_C, cid_Co, quorom_, minority, t_C, 
...
CoordinatorMainB(self) == /\ pc[self] = "CoordinatorMainB"
                          ...
                          /\ UNCHANGED << DataItems, Replicas, Transactions, 
                                          ...
                                          msg_C, type_C, recoveryTid, msg_Ha, 
                                          id_H, i_, j_, t_H, res_msg_, msg_Han, 
                                          id_Ha, i_H, j_H, t_Ha, res_msg_H, 
                                          msg_Hand, id_Han, i_Ha, j_Ha, t_Han, 
                                          res_msg_Ha, readValue, readWTS, 
                                          msg_Handl, id_Hand, i_Han, j_Han, 
...
ReplicaMain(self) == /\ pc[self] = "ReplicaMain"
                     ...
                     /\ UNCHANGED << DataItems, Replicas, Transactions, 
                                     ...
                                     idx, res_msg_Han, msg_Handle, id_Handl, 
                                     i_Hand, j_Hand, t_Handl, res_msg, msg, 
                                     id_Handle, i, j, id_N, msg_N, type, id_C, 
                                     s_msg_Co, i8, j8, id_, id_R >>
...
\* Last modified Fri Jul 19 14:43:20 CST 2024 by yqekzb
